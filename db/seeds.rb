...
second_post = Post.create(user_id: first_user.id, title: 'Hi', text: 'This is my second post')
third_post = Post.create(user_id: first_user.id, title: 'Hi there', text: 'This is my third post')
